...
Wire1_Coords = wire_coor(Wire1_test_)
print('Done 1!')

Wire2_Coords = wire_coor(Wire2_test_)
print('Done 2!')

Wire1_Coords.remove([0, 0])
Wire2_Coords.remove([0, 0])
...
for coord1 in Wire1_Coords:
    c += 1
    print(c)
    for coord2 in Wire2_Coords:
        if coord1[0] == coord2[0]:
            if coord1[1] == coord2[1]:
                Intercections += [coord1]
                Dists += [abs(coord1[0]) + abs(coord1[1])]
                print(abs(coord1[0]) + abs(coord1[1]))
            elif coord1[1] < coord2[1]:
                break
            else:
                Wire2_Coords.remove(coord2)
