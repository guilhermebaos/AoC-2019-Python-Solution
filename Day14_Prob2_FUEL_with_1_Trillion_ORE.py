...
while True:
    ...
    if look_to['ORE'] >= 1000000000000:
        print(fuel_we_can_get-1)
        break
    else:
        if fuel_we_can_get % 10 == 0:
            print(fuel_we_can_get, look_to['ORE'], len(str(look_to['ORE'])))

    if (1000000000000 - look_to['ORE'])//399063 > 1:
        fuel_we_can_get += (1000000000000 - look_to['ORE']) // 399063  # Este é o número de ORE necessário para 1 FUEL
    else:
        fuel_we_can_get += 1
